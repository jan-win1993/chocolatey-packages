...
if ( [environment]::OSVersion.Version.Major -ge 10 )  {
  $url32_win10      = 'https://downloads.spacedesk.net/downloads/spacedesk_driver_Win_10_32_v2226.msi'
  $checksum32_win10 = ''
  $url32            = $url32_win10
  $checksum32       = $checksum32_win10
  $url64_win10      = 'https://downloads.spacedesk.net/downloads/spacedesk_driver_Win_11_64_v2226.msi'
  $checksum64_win10 = ''
  $url64            = $url64_win10
